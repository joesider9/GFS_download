...
def main(args):
    ...
    parser = argparse.ArgumentParser(description=__doc__,
                                     epilog='Report bugs or suggestions to <alberto.torres@icmat.es>')
    parser.add_argument('-x', '--lon', help='longitude range [Default: %(default)s]', default=(-9.5, 4.5), nargs=2,
                        type=lon_type, metavar=('FIRST', 'LAST'))
    parser.add_argument('-y', '--lat', help='latitude range [Default: %(default)s]', default=(35.5, 44.0), nargs=2,
                        type=lat_type, metavar=('FIRST', 'LAST'))
    parser.add_argument('-t', '--time', help='time steps [Default: %(default)s]', type=int, nargs=2, default=(0, 180),
                        metavar=('FIRST', 'LAST'))
    parser.add_argument('-c', '--config', help='JSON file with meteo vars configuration [Default: %(default)s]',
                        type=str, default=None, metavar=('VAR_CONF'))
    parser.add_argument('-e', '--end-date', help='end date [Default: same as start date]', dest='end_date',
                        metavar='END_DATE')
    ...
    parser.add_argument('hour', metavar='HOUR', help='hour [Default: %(default)s]', type=int, choices=range1(0, 18, 6),
                        nargs='?', default=(0, 6, 12, 18))
